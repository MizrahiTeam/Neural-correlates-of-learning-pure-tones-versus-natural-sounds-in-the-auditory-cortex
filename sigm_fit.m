function [param,stat]=sigm_fit(x,y,fixed_params,initial_params,plot_flag,ncolor)
...
if plot_flag==1 
    ...
    plot(x_vector,f(param(isnan(fixed_params)),x_vector),'color',ncolor)
    hold on
        plot(x,y,'o','color',ncolor)
